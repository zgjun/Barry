...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.coreNormalColor) {
        _coreNormalColor = self.coreNormalColor;
    }
    else {
        _coreNormalColor = COLOR_GRAYISHBLUE;
    }
    
    if (self.coreSelectedColor) {
        _coreSelectedColor = self.coreSelectedColor;
    }
    else {
    ...
    if (self.strokeNormalColor) {
        _strokeNormalColor = self.strokeNormalColor;
    }
    else  {
    ...
    if (self.strokeSelectedColor) {
        _strokeSelectedColor = self.strokeSelectedColor;
    }
    else {
        if (self._pageControlStyle == PageControlStyleStrokedCircle || self._pageControlStyle == PageControlStyleWithPageNumber) {
