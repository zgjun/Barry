...
- (void)viewDidLoad
{
    ...
    _previousOverLayView.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.8];
...
- (void)pan:(UIPanGestureRecognizer *)pan
{
    ...
    switch (state) {
        case UIGestureRecognizerStateBegan:{
            ...
            self.previousOverLayView.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.8];
        ...
        case UIGestureRecognizerStateChanged:{
            ...
            self.previousOverLayView.backgroundColor = [[UIColor grayColor] colorWithAlphaComponent:0.8 * (1 - k)];
        ...
        case UIGestureRecognizerStateEnded:{
            ...
            [UIView animateWithDuration:0.3 animations:^{
                ...
                self.previousOverLayView.backgroundColor = reset ? [[UIColor grayColor] colorWithAlphaComponent:0.8] : [UIColor clearColor];
