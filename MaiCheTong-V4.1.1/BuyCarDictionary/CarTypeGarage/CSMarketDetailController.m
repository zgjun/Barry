...
@interface CSMarketDetailController ()<UIGestureRecognizerDelegate,UIActionSheetDelegate>
{
    enum WXScene _scene;
}
...
@implementation CSMarketDetailController

- (instancetype)initWithContentDict:(NSDictionary *)contentDict {
    if (self = [super init]) {
        self.contentDict = contentDict;
//        self.urlString = @"http://3g.chexun.com/app/article.aspx?newsId=102694689";
    }
    return self;
}
