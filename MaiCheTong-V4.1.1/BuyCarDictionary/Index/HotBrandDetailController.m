...
#import "HotBrandDetailController.h"
...
@interface HotBrandDetailController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation HotBrandDetailController
...
- (void)viewDidLoad {
    ...
    //品牌图标
    [brandImage sd_setImageWithURL:self.brandInfo[@"logo"] placeholderImage:[UIImage imageNamed:@"chexun_closeicon_gray"]];
    ...
    nameLabel.text = self.brandInfo[@"brandName"];
...
- (void)getData {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"http://api.tool.chexun.com/mobile/buyCarBrandDetail.do?brandId=%@",self.brandInfo[@"brandId"]];
    
    __weak HotBrandDetailController *myself = self;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    iconView.frame = CGRectMake(0, 0, 0.4 * ScreenWidth, 0.3 * ScreenWidth);
    [cell.contentView addSubview:iconView];
    
    UILabel *nameLabel = [[UILabel alloc]init];
    nameLabel.font = [UIFont systemFontOfSize:15];
    nameLabel.frame = CGRectMake(0.4 * ScreenWidth, 0.3 * ScreenWidth * 0.1, 0.4 * ScreenWidth , 0.3 * ScreenWidth * 0.4);
    nameLabel.textColor = MainLineGrayColor;
    nameLabel.text = dictList[@"name"];
    [cell.contentView addSubview:nameLabel];
    
    UILabel *priceLabel = [[UILabel alloc]init];
    priceLabel.font = [UIFont systemFontOfSize:15];
    priceLabel.frame = CGRectMake(0.4 * ScreenWidth, 0.3 * ScreenWidth * 0.5, 0.4 * ScreenWidth , 0.3 * ScreenWidth * 0.4);
    priceLabel.textColor = MainLineGrayColor;
    ...
    arrowImage.frame = CGRectMake(CGRectGetMaxX(priceLabel.frame), 0.3 * ScreenWidth * 0.5 + (0.3 * ScreenWidth * 0.4 - 15) * 0.5, 10, 15);
    ...
    reducePriceLabel.frame = CGRectMake(CGRectGetMaxX(arrowImage.frame), 0.3 * ScreenWidth * 0.5 + (0.3 * ScreenWidth * 0.4 - 15) * 0.5, 50, 15);
