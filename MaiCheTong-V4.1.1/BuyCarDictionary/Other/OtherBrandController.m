...
#import "OtherCarSeriesController.h"
...
@interface OtherBrandController ()<BrandCellViewDelegate,UITableViewDataSource,UITableViewDelegate,OtherCarSeriesDelegate,UIGestureRecognizerDelegate>
...
@property (nonatomic,strong) OtherCarSeriesController *otherCarSeriesVc;



@end

@implementation OtherBrandController
...
- (void)getData {
    ...
    __weak OtherBrandController *myself = self;
...
- (void)brandCellViewClick:(BrandCellView *)brandCellView {
    ...
    OtherCarSeriesController *otherCarSeriesVc;
    
    if ([self.indicator isEqualToString:@"CarType"]) {
        otherCarSeriesVc = [[OtherCarSeriesController alloc]initWithBrandInfo:brandCellView.dataDict indicator:@"CarType"];
    } else {
        otherCarSeriesVc = [[OtherCarSeriesController alloc]initWithBrandInfo:brandCellView.dataDict];
    }
    self.otherCarSeriesVc = otherCarSeriesVc;
    otherCarSeriesVc.delegate = self;
    otherCarSeriesVc.view.frame = CGRectMake(0, ScreenHeight, ScreenWidth, ScreenHeight - NavViewHeight);
    
    
    [self.view addSubview:otherCarSeriesVc.view];
    
    [self addChildViewController:otherCarSeriesVc];
    
    [UIView animateWithDuration:0.3 animations:^{
        otherCarSeriesVc.view.transform = CGAffineTransformMakeTranslation(0, - ScreenHeight + NavViewHeight);
    }];
}

- (void)otherCarSeriesSelected:(NSDictionary *)carSeriesDict {
    if ([self.delegate respondsToSelector:@selector(otherBrandSelected:)]) {
        [self.delegate otherBrandSelected:carSeriesDict];
    }
}
