...
- (void)layoutSubviews {
    ...
    self.timeLabel.frame = CGRectMake(self.width - 50, self.height - 30, 45, 20);
...
- (void)setContentDict:(NSDictionary *)contentDict {
    ...
    self.timeLabel.text = [TimeTool returnSampleTime:contentDict[@"time"]];
