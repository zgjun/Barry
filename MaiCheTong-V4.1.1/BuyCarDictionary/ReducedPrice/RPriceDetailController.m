...
@interface RPriceDetailController ()<UIActionSheetDelegate,UIGestureRecognizerDelegate>
{
    enum WXScene _scene;
}
...
@implementation RPriceDetailController
